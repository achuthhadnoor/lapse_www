    ...
    return (
        <Container>
            {!loading ? <div className="relative h-full w-md">
                <h1 className="text-4xl text-gray-200 text-center mt-10">Lapse 💚 <span className="text-green-500">You</span></h1>
                <p className="text-md leading-loose text-gray-200 max-w-4xl mx-4 xl:mx-auto mt-10">Hey Lpsers 👋,<br />
