...
const Timer = ({ type }: any) => {
  ...
  useEffect(() => {
    const countDownDate = new Date('December 31, 2022 15:37:25').getTime()
    ...
    <Container>
      ...
      <section className="relative px-4 sm:px-20">
        ...
        <div className="mt-5 flex items-center justify-center gap-2">
          ...
          <a href="https://github.com/achuthhadnoor/www/releases/download/0.0.1/Lapse-0.0.10-arm64.dmg">
            <div className="flex flex-col">
              <div className="flex items-center gap-2 rounded-lg bg-gray-100 px-2 py-1 align-middle text-black">
                <span className="flex">
                  <svg
