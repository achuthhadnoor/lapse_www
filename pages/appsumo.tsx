...
const Appsumo = (props: any) => {
  ...
  return (
    ...
    >
      <section className=" md:mx-auto flex md:flex-row mt-24 flex-col mx-2 bg-neutral-900 rounded-md p-4">
        <div className='justify-center flex flex-col'>
          <h1 className="flex items-center text-3xl mb-10">
            Lapse ❤️{' '}
            <svg
              width="150"
              height="24"
        ...
        <div className="mx-auto my-2 rounded-md px-4 py-5 shadow-md">
...
Appsumo.getInitialProps = async (ctx: { query: { appsumocode: any, email: string, version: string } }) => {
  if (ctx.query.appsumocode) {
    return { code: ctx.query.appsumocode }
  }
  return {
    code: ctx.query.appsumocode ? ctx.query.appsumocode : 'null',
    email: ctx.query.email ? ctx.query.email : '',
    version: ctx.query.version ? ctx.query.version : currentVersion,
  }
}
