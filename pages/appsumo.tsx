    ...
    return (
        ...
        >
            <section className=" mt-24 max-w-4xl mx-auto">
                <h1 className="flex align-middle justify-center text-3xl">Lapse ❤️ <svg width="150" height="24" viewBox="0 0 150 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_4746_241)">
                ...
                <div className="mt-2 my-5 mx-auto">
                    ...
                    <p className="my-5 max-w-xl leading-loose">
                        ...
                        <span className="mx-1 p-1 bg-indigo-800 text-indigo-200 rounded"> with life time access</span>.
                    </p>
                    <p className="my-5 max-w-xl leading-loose">
                        After submission, you will recieve the
                        <span className="mx-1 p-1 bg-indigo-800 text-indigo-200 rounded"> .dmg / .exe</span> 
                ...
                <div className="px-4 py-5 rounded-md shadow-md my-5 mx-auto bg-gray-900">
                    ...
                    >
                        <input
                            className={cn(
                                ...
                                "px-2 py-1 rounded outline-none shadow text-sm focus:ring-2 focus:ring-indigo-400 bg-gray-800")}
                            type="email"
                        ...
                        />
                        <input
                            className="px-2 py-1 rounded outline-none shadow text-sm focus:ring-2 focus:ring-indigo-500 bg-gray-800"
                            type="text"
                            ...
                            <button
                                ...
                                className={cn(
                                    loading || code.length !== 19
                                      ? "cursor-not-allowed"
                                      : "cursor-pointer",
                                      "inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 disabled:bg-gray-500"
                                  )}
