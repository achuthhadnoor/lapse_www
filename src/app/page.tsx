  ...
  return (
    <>
      ...
      >
        ...
        {/* Stats Section */}
        <div className="p-2 border border-neutral-400 rounded-lg w-full ">
          <div className="flex border-neutral-400 flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8  py-5 px-8 border rounded-lg w-full ">
            {/* Monthly Users */}
            <div className="text-center">
              <p className="text-gray-400 mb-1">Used by</p>
              <h2 className="text-4xl font-bold">2800</h2>
              <p className="text-gray-400">Monthly users</p>
            </div>

            {/* Time-lapses Created */}
            <div className="text-center">
              <p className="text-gray-400 mb-1">Time-lapses created</p>
              <h2 className="text-4xl font-bold">8400</h2>
              <p className="text-gray-400">files</p>
            </div>

            {/* Time Saved */}
            <div className="text-center ">
              <p className="text-gray-400 mb-1">Time saved</p>
              <h2 className="text-4xl font-bold">17900</h2>
